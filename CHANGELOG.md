...
- [ 機能追加 ] ペインが入力待ち・マージ待ちになった瞬間に、登録済みのスマートフォンへ Web Push（ブラウザが標準で持つ、ページを閉じていても通知を受け取れる仕組み）で通知を送れるように追加。モバイルページの「🔔 通知」カードから登録・停止できる（[#396](https://github.com/vektor-inc/vk-terminals/issues/396)）
